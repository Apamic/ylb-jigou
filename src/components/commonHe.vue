  ...
  <div class="head-box hxmggtou">
    <div class="left">
      ...
      <div class="left-body">
        ...
        <ul class="gl-ul">
          <li @click="$router.push('/PhysicalCommodity')">实物商品</li>
...
<!--          <el-breadcrumb-item>{{itemHead}}</el-breadcrumb-item>-->
    ...
    export default {
        ...
        methods: {
            ...
            jksc(e) {
                ...
                this.itemHead = e.currentTarget.parentElement.previousElementSibling.innerHTML
                this.item = e.currentTarget.innerHTML
            },
            yygl(e) {
            ...
            nrgl(e) {
                ...
                localStorage.setItem('headLv1',e.currentTarget.parentElement.previousElementSibling.innerHTML)
                localStorage.setItem('headLv2',e.currentTarget.innerHTML)
                console.log(e.currentTarget.innerHTML)
                console.log(e.currentTarget.parentElement)
                this.itemHead = e.currentTarget.parentElement.previousElementSibling.innerHTML
                this.item = e.currentTarget.innerHTML
                console.log(e.currentTarget.parentElement.previousElementSibling.innerHTML)
            },
            nrsh(e) {
                localStorage.setItem('headLv1',e.currentTarget.parentElement.previousElementSibling.innerHTML)
                localStorage.setItem('headLv2',e.currentTarget.innerHTML)
        ...
        mounted() {
            ...
            this.item = localStorage.getItem("headLv2")
            this.itemHead = localStorage.getItem("headLv1")
            // alert( this.token)
