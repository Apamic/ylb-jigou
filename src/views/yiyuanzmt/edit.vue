                  ...
                  <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                    ...
                    <el-form-item label="关键词" prop="dynamicTags">
                      <div class="">
                        <el-tag
                          :key="index"
                          v-for="(tag,index) in ruleForm.dynamicTags"
                          closable
    ...
    export default {
        ...
        methods: {
            ...
            submitForm() {
                ...
                //     if (this.ruleForm.textarea && this.dynamicTags && this.ruleForm.name && this.ruleForm.radio && this.ruleForm.groups) {
                //         var submitList = {
                //             "newsId": localStorage.getItem("newsId"),
                //             "content": this.ruleForm.textarea,
                //             "newsStyle": this.ruleForm.radio,
                //             "tags": this.dynamicTags,
                //             "title": this.ruleForm.name,
                //             "newsClassifyIds": this.allSelect
                //         }
        ...
        created() {
            ...
            newsDetail(list).then(data => {
                ...
                this.tpId = data.data.newsStyle
                this.ruleForm.radio = data.data.newsStyle
                this.ruleForm.name = data.data.title
                this.ruleForm.textarea = data.data.content
                this.dynamicTags = data.data.tags
                this.ruleForm.dynamicTags = data.data.tags
                // this.rad=data.data.newsStyle
                this.picsList = data.data.coverResUrls
                // this.tpId=data.data.tpId
                this.ruleForm.groups = data.data.newsClassifyIds
                this.allSelect = data.data.newsClassifyIds
