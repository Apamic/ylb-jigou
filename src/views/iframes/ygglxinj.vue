          ...
          <el-tabs type="border-card">
            ...
            <el-tab-pane class="jibenform" label="基本信息">
              <el-form :model="doctorForm"
                ...
                <el-form-item label="类型" prop="drType">
                ...
                <el-form-item label="手机号" prop="mobile">
                  <el-input v-model="doctorForm.mobile" :disabled="disabled"></el-input>
                </el-form-item>
                ...
                <el-form-item label="所属科室" prop="deptUpId">
                  <el-select v-model="doctorForm.deptUpId" placeholder="请选择科室" @change="doctorForm.deptId = ''">
                    <el-option
                ...
                <el-form-item label="二级科室" prop="deptId">
                  <el-select v-model="doctorForm.deptId" placeholder="请选择二级科室">
                    <el-option
        ...
        watch: {
            ...
            'doctorForm.deptUpId'() {
                if (this.type.deptList) {
                    this.type.deptList.forEach(item => {
                        if (this.doctorForm.deptUpId == item.deptId) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        this.$axios({
                            ...
                            this.$router.go(-1) // console.log('add',res)
