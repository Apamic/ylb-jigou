...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.sourceIds =  this.obj.sourceIds.join('')
            // console.log(this.data)
            // console.log('传来的下标',this.boxIndex)
            // console.log(this.obj.sourceIds.join(''))
            // console.log(this.obj)
            // this.sourceIds =
            // console.log(this.data)
            ...
            addComponent() {
                ...
                if (this.property.exist) {
                    ...
                    this.dataList.forEach(item => {
                        if (item.comId == "1160791584212520965") {
                            index = index + 1
                        }
                    })

                    if (index >= 10) {
                        return console.log('最多添加10个')
                    } else {
                        this.$emit('addComponent',{
                            comId: "1160791584212520965",
                            comUrl: "http://admintest.16health.com:9005/f//201909/2c/2c4f5c8ee43e45e58eed6b8bb6bb6608.png",
                            listStyle: "1041101",
                            detailsName: "精选专家",
                            sourceIds: ['0'],
                            sourceType: "1042102"
