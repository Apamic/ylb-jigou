...
<!--          <div class="edit">点击编辑</div>-->
      ...
      <poster :property="componentsList[tabIndex]" :data="page.detailsList"
              ...
              @newPage="newPage" :boxIndex="boxIndex"></poster>
      <selectExperts :property="componentsList[tabIndex]" :data="page.detailsList"
                     ...
                     @newPage="newPage" :boxIndex="boxIndex"></selectExperts>
      ...
      <actciles :property="componentsList[tabIndex]" :data="page.detailsList" v-if="tabIndex == 4" @onSubmit="onSubmit"
                @addComponent="addComponent" @newPage="newPage" :boxIndex="boxIndex"></actciles>
    ...
    export default {
        ...
        methods: {
            ...
            addComponentShow(index) {
                ...
                //     this.preview = ''
                // } else {
                    this.preview = this.componentsList[this.tabIndex].comUrl
                // }
            ...
            closemall(index) {
                ...
                console.log(this.page.detailsList[index].comId)

                let id = this.page.detailsList[index].comId
                let exist = 'no'
                // this.componentsList[this.tabIndex].exist = false
                this.page.detailsList.splice(index, 1)
                console.log('删除',this.tabIndex)
