<template>
    <div>
        <commonHe></commonHe>
        <div>
            <iframe id="show-iframe" frameborder=0 scrolling="yes" style="overflow-y:auto;" :src="'http://47.92.25.25/finance/page/finance/order_medic_svc.shtml?orgId='+orgId"></iframe>
        </div> 
    </div>
</template>
<script>
