...
<!--                    </el-table-column>-->
                    <el-table-column prop="deptId" label="编号" width="220px">
                    </el-table-column>
...
<!--                        <el-button type="text" size="small">分享</el-button>-->
                        <el-button type="text" size="small" v-if="scope.row.deptId.length > 7">
              ...
              <div>
                <el-dialog title="编辑" :visible.sync="dialogFormVisible2">
                  <el-form :model="form">
                    <el-form-item label="上级科室" :label-width="formLabelWidth">
                      <el-select v-model="form.deptUpId" placeholder="请选择上级科室" :disabled="disabled">
                        <el-option
                    ...
                    <el-form-item label="科室编号" :label-width="formLabelWidth">
                      <el-input v-model="form.deptId" autocomplete="off" :disabled="disabled"></el-input>
                    </el-form-item>
                    <el-form-item label="科室名称" :label-width="formLabelWidth">
                      <el-input v-model="form.deptName" autocomplete="off"></el-input>
                    </el-form-item>
                ...
                <el-row class="tou-btn">
                  <div style="display: flex;justify-content: space-between;">
                    ...
                    <div style="display: flex;">
                      <el-input placeholder="请输入内容" v-model="search" class="keshissk">
                        <el-button slot="append" @click="tsSearch" type="primary">搜索</el-button>
                      </el-input>
                    </div>
                  </div>
                </el-row>
