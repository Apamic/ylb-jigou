    ...
    <div class="zhaomu">
      ...
      <div class="xqms">
        ...
        <div class="edit_container xqms-textarea">
          ...
          <el-button type="primary" @click="godown" style="margin-top:30px;">保存</el-button>
        </div>
        <!--<div>-->
  ...
  export default {
    data() {
      return {
        ...
        input2:"999",
        input3:"高级推广员招募计划",
        textarea:"<p><img src='http://47.92.159.136/mall/upload/2019/9/20/848ec9dd-1beb-454b-8d76-9eeb6f72fede.png' width='100%'/></p><p>一、奖励说明</p><p>	1.用户点击您分享的推广链接即会绑定成为您的客户，在有效期内购买任意参与推广的商品，您将获得对应比例的佣金奖励。 </p><p>	2.您可以邀请好友成为您的下级推广员，用户在你邀请的下级推广员的推广下成功付费，您将获得对应比例的邀请奖励。</p><p>二、结算说明</p><p>	1.您所获得的每笔订单的奖励依据商品的分成比例有所不同。</p><p>	2.您可以在“首页-我的-我的钱包”查看您的收益数据，并进行提现操作。</p>",
        editorOption: {},
        isOrdinary:'',
        isHighLevel:'',
        // 初始化判断是否设置过Id查询：
